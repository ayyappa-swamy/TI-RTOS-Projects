...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[7176];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/ayyappa/TIRTOSLabsWS/Lab_05/Debug/configPkg/package/cfg/empty_pem4f");
...
__FAR__ const CT__ti_sysbios_BIOS_Module__id ti_sysbios_BIOS_Module__id__C = (xdc_Bits16)0x802e;
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1c08;
...
#endif
#endif
const ti_sysbios_hal_Hwi_Handle HWI_TIMER2A = (ti_sysbios_hal_Hwi_Handle)((ti_sysbios_hal_Hwi_Handle)&ti_sysbios_hal_Hwi_Object__table__V[0]);
