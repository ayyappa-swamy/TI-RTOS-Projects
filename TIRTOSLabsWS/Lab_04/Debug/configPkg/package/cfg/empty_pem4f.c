...
/* --> ledToggle */
extern xdc_Void ledToggle(xdc_Void);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[7164];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/ayyappa/TIRTOSLabsWS/Lab_04/Debug/configPkg/package/cfg/empty_pem4f");
...
const __T1_ti_sysbios_knl_Idle_funcList ti_sysbios_knl_Idle_funcList__A[3] = {
    ((xdc_Void(*)(xdc_Void))((xdc_Fxn)ledToggle)),  /* [0] */
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1bfc;
