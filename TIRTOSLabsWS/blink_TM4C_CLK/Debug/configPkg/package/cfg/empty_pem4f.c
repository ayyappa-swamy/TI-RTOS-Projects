...
/* --> ledToggle */
extern xdc_Void ledToggle(xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[8114];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/ayyappa/TIRTOSLabsWS/blink_TM4C_CLK/Debug/configPkg/package/cfg/empty_pem4f");
...
__FAR__ const CT__ti_sysbios_hal_Hwi_E_stackOverflow ti_sysbios_hal_Hwi_E_stackOverflow__C = (((xdc_runtime_Error_Id)4459) << 16 | 0);
...
__FAR__ const CT__ti_sysbios_heaps_HeapMem_E_memory ti_sysbios_heaps_HeapMem_E_memory__C = (((xdc_runtime_Error_Id)4381) << 16 | 0);
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)ledToggle)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1fb2;
