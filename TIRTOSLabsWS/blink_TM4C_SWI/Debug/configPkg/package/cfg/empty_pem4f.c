...
/*
 * ======== ti.uia.loggers.LoggerMin INTERNALS ========
 */

/* Module__ */
typedef struct ti_uia_loggers_LoggerMin_Module__ {
    xdc_runtime_Types_Link link;
} ti_uia_loggers_LoggerMin_Module__;

/* Module__root__V */
extern ti_uia_loggers_LoggerMin_Module__ ti_uia_loggers_LoggerMin_Module__root__V;

/* Object__ */
typedef struct ti_uia_loggers_LoggerMin_Object__ {
    const ti_uia_loggers_LoggerMin_Fxns__ *__fxns;
} ti_uia_loggers_LoggerMin_Object__;

/* Object2__ */
typedef struct {
    xdc_runtime_Types_InstHdr hdr;
    ti_uia_loggers_LoggerMin_Object__ obj;
} ti_uia_loggers_LoggerMin_Object2__;

/* __ParamsPtr */
#ifdef ti_uia_loggers_LoggerMin___VERS
    #define ti_uia_loggers_LoggerMin___ParamsPtr xdc_UChar*
#else
    #define ti_uia_loggers_LoggerMin___ParamsPtr xdc_Ptr
#endif
...
/*
 * ======== ti.uia.loggers.LoggerMin VTABLE ========
 */

/* Module__FXNS__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__FXNS__C, ".const:ti_uia_loggers_LoggerMin_Module__FXNS__C");
const ti_uia_loggers_LoggerMin_Fxns__ ti_uia_loggers_LoggerMin_Module__FXNS__C = {
    (void*)&xdc_runtime_ILogger_Interface__BASE__C, /* __base */
    &ti_uia_loggers_LoggerMin_Module__FXNS__C.__sfxns, /* __sysp */
    ti_uia_loggers_LoggerMin_enable__E,
    ti_uia_loggers_LoggerMin_disable__E,
    ti_uia_loggers_LoggerMin_write0__E,
    ti_uia_loggers_LoggerMin_write1__E,
    ti_uia_loggers_LoggerMin_write2__E,
    ti_uia_loggers_LoggerMin_write4__E,
    ti_uia_loggers_LoggerMin_write8__E,
    {
        ti_uia_loggers_LoggerMin_Object__create__S,
        ti_uia_loggers_LoggerMin_Object__delete__S,
        ti_uia_loggers_LoggerMin_Handle__label__S,
        0x803b, /* __mid */
    } /* __sfxns */
};
...
/* --> ledToggle */
extern xdc_Void ledToggle(xdc_UArg,xdc_UArg);
...
/*
 * ======== ti.uia.loggers.LoggerMin DECLARATIONS ========
 */

/* Object__table__V */
ti_uia_loggers_LoggerMin_Object__ ti_uia_loggers_LoggerMin_Object__table__V[1];

/* Module_State__ */
typedef struct ti_uia_loggers_LoggerMin_Module_State__ {
    xdc_Bool enabled;
    xdc_Bool empty;
...
} ti_uia_loggers_LoggerMin_Module_State__;
#ifdef __IAR_SYSTEMS_ICC__
    #pragma data_alignment=1
#endif

/* --> ti_uia_loggers_LoggerMin_Module_State_0_packetBuffer__A */
__T1_ti_uia_loggers_LoggerMin_Module_State__packetBuffer ti_uia_loggers_LoggerMin_Module_State_0_packetBuffer__A[512];
#ifdef __ti__align
    #pragma DATA_ALIGN(ti_uia_loggers_LoggerMin_Module_State_0_packetBuffer__A, 1);
#endif
#ifdef __GNUC__
#ifndef __TI_COMPILER_VERSION__
__T1_ti_uia_loggers_LoggerMin_Module_State__packetBuffer ti_uia_loggers_LoggerMin_Module_State_0_packetBuffer__A[512] __attribute__ ((aligned(1)));
#endif
#endif

/* Module__state__V */
ti_uia_loggers_LoggerMin_Module_State__ ti_uia_loggers_LoggerMin_Module__state__V;
...
/* --> ti_uia_loggers_LoggerMin_Module_startup__E */
extern xdc_Int ti_uia_loggers_LoggerMin_Module_startup__E(xdc_Int);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[8055];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/ayyappa/TIRTOSLabsWS/blink_TM4C_SWI/Debug/configPkg/package/cfg/empty_pem4f");
...
xdc_Bool ti_uia_loggers_LoggerMin_Module__startupDone__F(void) {
...
/*
 * ======== ti.uia.loggers.LoggerMin TEMPLATE ========
 */
...
{
    register UInt32* bufferPtr = ti_uia_loggers_LoggerMin_Module__state__V.start;
    ...
    ti_uia_runtime_UIAPacket_setMinEventPacketLength(
            ...
            (((UInt32)ti_uia_loggers_LoggerMin_Module__state__V.write - (UInt32)bufferPtr)) * 1,
            0);

    /* Update ptr to new buffer */
    ti_uia_loggers_LoggerMin_Module__state__V.write = bufferPtr + 1;
}
        ...
        IArg p1, IArg p2, IArg p3, IArg p4, IArg p5, IArg p6, IArg p7, IArg p8)
{
    ...
    register UInt32 *writePtr = ti_uia_loggers_LoggerMin_Module__state__V.write;
    UInt32 totalBytesInEvent;

    /* Add the number of bytes in the timestamp (0, 4, or 8) */
    totalBytesInEvent = numBytesInEvent + 4;

    if (((UInt32)writePtr +
                (totalBytesInEvent + 4) / (4 / sizeof(UInt32))) >=
            (UInt32)ti_uia_loggers_LoggerMin_Module__state__V.end) {

        ti_uia_runtime_UIAPacket_setMinEventPacketLength(
            (ti_uia_runtime_UIAPacket_Hdr*)ti_uia_loggers_LoggerMin_Module__state__V.start,
            (((UInt32)ti_uia_loggers_LoggerMin_Module__state__V.write -
                    (UInt32)ti_uia_loggers_LoggerMin_Module__state__V.start)) * 1,
            0);

        writePtr = ti_uia_loggers_LoggerMin_Module__state__V.start + 1;
    }

    *writePtr++ = ti_uia_runtime_EventHdr_genEventWithPrevLenHdrWord1(
        totalBytesInEvent,
        ti_uia_loggers_LoggerMin_Module__state__V.numBytesInPrevEvent,
        ti_uia_loggers_LoggerMin_Module__state__V.eventSequenceNum,
        ti_uia_loggers_LoggerMin_Module__state__V.eventType);
    ...
    *writePtr++ = xdc_runtime_Types_makeEvent(xdc_runtime_Log_getEventId(evt),
    ...
    if (numBytesInEvent >= 12) {
        *writePtr++ = p1;

        if (numBytesInEvent >= 16) {
            *writePtr++ = p2;

            if (numBytesInEvent >= 24) {
                *writePtr++ = p3;
                *writePtr++ = p4;

                if (numBytesInEvent == 40) {
                    *writePtr++ = p5;
                    *writePtr++ = p6;
                    *writePtr++ = p7;
                    *writePtr++ = p8;
    ...
    ti_uia_loggers_LoggerMin_Module__state__V.eventSequenceNum++;
    ti_uia_loggers_LoggerMin_Module__state__V.numBytesInPrevEvent = totalBytesInEvent;
    ...
    *writePtr = ti_uia_runtime_EventHdr_genEventWithPrevLenHdrWord1(
    ...
    ti_uia_loggers_LoggerMin_Module__state__V.write = writePtr;
...
__FAR__ const CT__ti_sysbios_family_arm_lm4_Timer_E_invalidTimer ti_sysbios_family_arm_lm4_Timer_E_invalidTimer__C = (((xdc_runtime_Error_Id)4982) << 16 | 0);
...
__FAR__ const CT__ti_sysbios_family_arm_lm4_Timer_E_notAvailable ti_sysbios_family_arm_lm4_Timer_E_notAvailable__C = (((xdc_runtime_Error_Id)5018) << 16 | 0);
...
__FAR__ const CT__ti_sysbios_family_arm_lm4_Timer_E_cannotSupport ti_sysbios_family_arm_lm4_Timer_E_cannotSupport__C = (((xdc_runtime_Error_Id)5057) << 16 | 0);
...
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_Module__id ti_sysbios_family_arm_m3_Hwi_Module__id__C = (xdc_Bits16)0x8037;
...
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_A_unsupportedMaskingOption ti_sysbios_family_arm_m3_Hwi_A_unsupportedMaskingOption__C = (((xdc_runtime_Assert_Id)3915) << 16 | 16);
...
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_alreadyDefined ti_sysbios_family_arm_m3_Hwi_E_alreadyDefined__C = (((xdc_runtime_Error_Id)4496) << 16 | 0);
...
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_hwiLimitExceeded ti_sysbios_family_arm_m3_Hwi_E_hwiLimitExceeded__C = (((xdc_runtime_Error_Id)4544) << 16 | 0);

/* E_exception__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_exception__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_exception__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_exception ti_sysbios_family_arm_m3_Hwi_E_exception__C = (((xdc_runtime_Error_Id)4592) << 16 | 0);

/* E_noIsr__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_noIsr__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_noIsr__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_noIsr ti_sysbios_family_arm_m3_Hwi_E_noIsr__C = (((xdc_runtime_Error_Id)4797) << 16 | 0);

/* E_NMI__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_NMI__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_NMI__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_NMI ti_sysbios_family_arm_m3_Hwi_E_NMI__C = (((xdc_runtime_Error_Id)4825) << 16 | 0);

/* E_hardFault__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_hardFault__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_hardFault__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_hardFault ti_sysbios_family_arm_m3_Hwi_E_hardFault__C = (((xdc_runtime_Error_Id)4835) << 16 | 0);

/* E_memFault__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_memFault__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_memFault__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_memFault ti_sysbios_family_arm_m3_Hwi_E_memFault__C = (((xdc_runtime_Error_Id)4851) << 16 | 0);

/* E_busFault__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_busFault__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_busFault__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_busFault ti_sysbios_family_arm_m3_Hwi_E_busFault__C = (((xdc_runtime_Error_Id)4881) << 16 | 0);

/* E_usageFault__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_usageFault__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_usageFault__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_usageFault ti_sysbios_family_arm_m3_Hwi_E_usageFault__C = (((xdc_runtime_Error_Id)4911) << 16 | 0);

/* E_svCall__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_svCall__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_svCall__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_svCall ti_sysbios_family_arm_m3_Hwi_E_svCall__C = (((xdc_runtime_Error_Id)4928) << 16 | 0);

/* E_debugMon__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_debugMon__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_debugMon__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_debugMon ti_sysbios_family_arm_m3_Hwi_E_debugMon__C = (((xdc_runtime_Error_Id)4949) << 16 | 0);

/* E_reserved__C */
#pragma DATA_SECTION(ti_sysbios_family_arm_m3_Hwi_E_reserved__C, ".const:ti_sysbios_family_arm_m3_Hwi_E_reserved__C");
__FAR__ const CT__ti_sysbios_family_arm_m3_Hwi_E_reserved ti_sysbios_family_arm_m3_Hwi_E_reserved__C = (((xdc_runtime_Error_Id)4964) << 16 | 0);
...
__FAR__ const CT__ti_sysbios_family_arm_m3_IntrinsicsSupport_Module__id ti_sysbios_family_arm_m3_IntrinsicsSupport_Module__id__C = (xdc_Bits16)0x8038;
...
__FAR__ const CT__ti_sysbios_family_arm_m3_TaskSupport_Module__id ti_sysbios_family_arm_m3_TaskSupport_Module__id__C = (xdc_Bits16)0x8039;
...
__FAR__ const CT__ti_sysbios_gates_GateMutex_A_badContext ti_sysbios_gates_GateMutex_A_badContext__C = (((xdc_runtime_Assert_Id)3716) << 16 | 16);
...
__FAR__ const CT__ti_sysbios_heaps_HeapMem_A_zeroBlock ti_sysbios_heaps_HeapMem_A_zeroBlock__C = (((xdc_runtime_Assert_Id)2579) << 16 | 16);

/* A_heapSize__C */
#pragma DATA_SECTION(ti_sysbios_heaps_HeapMem_A_heapSize__C, ".const:ti_sysbios_heaps_HeapMem_A_heapSize__C");
__FAR__ const CT__ti_sysbios_heaps_HeapMem_A_heapSize ti_sysbios_heaps_HeapMem_A_heapSize__C = (((xdc_runtime_Assert_Id)2615) << 16 | 16);

/* A_align__C */
#pragma DATA_SECTION(ti_sysbios_heaps_HeapMem_A_align__C, ".const:ti_sysbios_heaps_HeapMem_A_align__C");
__FAR__ const CT__ti_sysbios_heaps_HeapMem_A_align ti_sysbios_heaps_HeapMem_A_align__C = (((xdc_runtime_Assert_Id)2660) << 16 | 16);

/* E_memory__C */
#pragma DATA_SECTION(ti_sysbios_heaps_HeapMem_E_memory__C, ".const:ti_sysbios_heaps_HeapMem_E_memory__C");
__FAR__ const CT__ti_sysbios_heaps_HeapMem_E_memory ti_sysbios_heaps_HeapMem_E_memory__C = (((xdc_runtime_Error_Id)4418) << 16 | 0);

/* A_invalidFree__C */
#pragma DATA_SECTION(ti_sysbios_heaps_HeapMem_A_invalidFree__C, ".const:ti_sysbios_heaps_HeapMem_A_invalidFree__C");
__FAR__ const CT__ti_sysbios_heaps_HeapMem_A_invalidFree ti_sysbios_heaps_HeapMem_A_invalidFree__C = (((xdc_runtime_Assert_Id)2551) << 16 | 16);
...
__FAR__ const CT__ti_sysbios_knl_Event_Module__loggerObj ti_sysbios_knl_Event_Module__loggerObj__C = ((CT__ti_sysbios_knl_Event_Module__loggerObj)((void*)(xdc_runtime_ILogger_Handle)&ti_uia_loggers_LoggerMin_Object__table__V[0]));

/* Module__loggerFxn0__C */
#pragma DATA_SECTION(ti_sysbios_knl_Event_Module__loggerFxn0__C, ".const:ti_sysbios_knl_Event_Module__loggerFxn0__C");
__FAR__ const CT__ti_sysbios_knl_Event_Module__loggerFxn0 ti_sysbios_knl_Event_Module__loggerFxn0__C = ((CT__ti_sysbios_knl_Event_Module__loggerFxn0)((xdc_Fxn)ti_uia_loggers_LoggerMin_write0));

/* Module__loggerFxn1__C */
#pragma DATA_SECTION(ti_sysbios_knl_Event_Module__loggerFxn1__C, ".const:ti_sysbios_knl_Event_Module__loggerFxn1__C");
__FAR__ const CT__ti_sysbios_knl_Event_Module__loggerFxn1 ti_sysbios_knl_Event_Module__loggerFxn1__C = ((CT__ti_sysbios_knl_Event_Module__loggerFxn1)((xdc_Fxn)ti_uia_loggers_LoggerMin_write1));

/* Module__loggerFxn2__C */
#pragma DATA_SECTION(ti_sysbios_knl_Event_Module__loggerFxn2__C, ".const:ti_sysbios_knl_Event_Module__loggerFxn2__C");
__FAR__ const CT__ti_sysbios_knl_Event_Module__loggerFxn2 ti_sysbios_knl_Event_Module__loggerFxn2__C = ((CT__ti_sysbios_knl_Event_Module__loggerFxn2)((xdc_Fxn)ti_uia_loggers_LoggerMin_write2));

/* Module__loggerFxn4__C */
#pragma DATA_SECTION(ti_sysbios_knl_Event_Module__loggerFxn4__C, ".const:ti_sysbios_knl_Event_Module__loggerFxn4__C");
__FAR__ const CT__ti_sysbios_knl_Event_Module__loggerFxn4 ti_sysbios_knl_Event_Module__loggerFxn4__C = ((CT__ti_sysbios_knl_Event_Module__loggerFxn4)((xdc_Fxn)ti_uia_loggers_LoggerMin_write4));

/* Module__loggerFxn8__C */
#pragma DATA_SECTION(ti_sysbios_knl_Event_Module__loggerFxn8__C, ".const:ti_sysbios_knl_Event_Module__loggerFxn8__C");
__FAR__ const CT__ti_sysbios_knl_Event_Module__loggerFxn8 ti_sysbios_knl_Event_Module__loggerFxn8__C = ((CT__ti_sysbios_knl_Event_Module__loggerFxn8)((xdc_Fxn)ti_uia_loggers_LoggerMin_write8));
...
ti_sysbios_knl_Swi_Object__ ti_sysbios_knl_Swi_Object__table__V[2] = {
    {/* instance#0 */
        ...
        ((xdc_Void(*)(xdc_UArg,xdc_UArg))((xdc_Fxn)ledToggle)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
...
__FAR__ const CT__ti_sysbios_knl_Swi_Module__loggerObj ti_sysbios_knl_Swi_Module__loggerObj__C = ((CT__ti_sysbios_knl_Swi_Module__loggerObj)((void*)(xdc_runtime_ILogger_Handle)&ti_uia_loggers_LoggerMin_Object__table__V[0]));

/* Module__loggerFxn0__C */
#pragma DATA_SECTION(ti_sysbios_knl_Swi_Module__loggerFxn0__C, ".const:ti_sysbios_knl_Swi_Module__loggerFxn0__C");
__FAR__ const CT__ti_sysbios_knl_Swi_Module__loggerFxn0 ti_sysbios_knl_Swi_Module__loggerFxn0__C = ((CT__ti_sysbios_knl_Swi_Module__loggerFxn0)((xdc_Fxn)ti_uia_loggers_LoggerMin_write0));

/* Module__loggerFxn1__C */
#pragma DATA_SECTION(ti_sysbios_knl_Swi_Module__loggerFxn1__C, ".const:ti_sysbios_knl_Swi_Module__loggerFxn1__C");
__FAR__ const CT__ti_sysbios_knl_Swi_Module__loggerFxn1 ti_sysbios_knl_Swi_Module__loggerFxn1__C = ((CT__ti_sysbios_knl_Swi_Module__loggerFxn1)((xdc_Fxn)ti_uia_loggers_LoggerMin_write1));

/* Module__loggerFxn2__C */
#pragma DATA_SECTION(ti_sysbios_knl_Swi_Module__loggerFxn2__C, ".const:ti_sysbios_knl_Swi_Module__loggerFxn2__C");
__FAR__ const CT__ti_sysbios_knl_Swi_Module__loggerFxn2 ti_sysbios_knl_Swi_Module__loggerFxn2__C = ((CT__ti_sysbios_knl_Swi_Module__loggerFxn2)((xdc_Fxn)ti_uia_loggers_LoggerMin_write2));

/* Module__loggerFxn4__C */
#pragma DATA_SECTION(ti_sysbios_knl_Swi_Module__loggerFxn4__C, ".const:ti_sysbios_knl_Swi_Module__loggerFxn4__C");
__FAR__ const CT__ti_sysbios_knl_Swi_Module__loggerFxn4 ti_sysbios_knl_Swi_Module__loggerFxn4__C = ((CT__ti_sysbios_knl_Swi_Module__loggerFxn4)((xdc_Fxn)ti_uia_loggers_LoggerMin_write4));

/* Module__loggerFxn8__C */
#pragma DATA_SECTION(ti_sysbios_knl_Swi_Module__loggerFxn8__C, ".const:ti_sysbios_knl_Swi_Module__loggerFxn8__C");
__FAR__ const CT__ti_sysbios_knl_Swi_Module__loggerFxn8 ti_sysbios_knl_Swi_Module__loggerFxn8__C = ((CT__ti_sysbios_knl_Swi_Module__loggerFxn8)((xdc_Fxn)ti_uia_loggers_LoggerMin_write8));
...
__FAR__ const CT__ti_sysbios_knl_Task_Module__loggerObj ti_sysbios_knl_Task_Module__loggerObj__C = ((CT__ti_sysbios_knl_Task_Module__loggerObj)((void*)(xdc_runtime_ILogger_Handle)&ti_uia_loggers_LoggerMin_Object__table__V[0]));

/* Module__loggerFxn0__C */
#pragma DATA_SECTION(ti_sysbios_knl_Task_Module__loggerFxn0__C, ".const:ti_sysbios_knl_Task_Module__loggerFxn0__C");
__FAR__ const CT__ti_sysbios_knl_Task_Module__loggerFxn0 ti_sysbios_knl_Task_Module__loggerFxn0__C = ((CT__ti_sysbios_knl_Task_Module__loggerFxn0)((xdc_Fxn)ti_uia_loggers_LoggerMin_write0));

/* Module__loggerFxn1__C */
#pragma DATA_SECTION(ti_sysbios_knl_Task_Module__loggerFxn1__C, ".const:ti_sysbios_knl_Task_Module__loggerFxn1__C");
__FAR__ const CT__ti_sysbios_knl_Task_Module__loggerFxn1 ti_sysbios_knl_Task_Module__loggerFxn1__C = ((CT__ti_sysbios_knl_Task_Module__loggerFxn1)((xdc_Fxn)ti_uia_loggers_LoggerMin_write1));

/* Module__loggerFxn2__C */
#pragma DATA_SECTION(ti_sysbios_knl_Task_Module__loggerFxn2__C, ".const:ti_sysbios_knl_Task_Module__loggerFxn2__C");
__FAR__ const CT__ti_sysbios_knl_Task_Module__loggerFxn2 ti_sysbios_knl_Task_Module__loggerFxn2__C = ((CT__ti_sysbios_knl_Task_Module__loggerFxn2)((xdc_Fxn)ti_uia_loggers_LoggerMin_write2));

/* Module__loggerFxn4__C */
#pragma DATA_SECTION(ti_sysbios_knl_Task_Module__loggerFxn4__C, ".const:ti_sysbios_knl_Task_Module__loggerFxn4__C");
__FAR__ const CT__ti_sysbios_knl_Task_Module__loggerFxn4 ti_sysbios_knl_Task_Module__loggerFxn4__C = ((CT__ti_sysbios_knl_Task_Module__loggerFxn4)((xdc_Fxn)ti_uia_loggers_LoggerMin_write4));

/* Module__loggerFxn8__C */
#pragma DATA_SECTION(ti_sysbios_knl_Task_Module__loggerFxn8__C, ".const:ti_sysbios_knl_Task_Module__loggerFxn8__C");
__FAR__ const CT__ti_sysbios_knl_Task_Module__loggerFxn8 ti_sysbios_knl_Task_Module__loggerFxn8__C = ((CT__ti_sysbios_knl_Task_Module__loggerFxn8)((xdc_Fxn)ti_uia_loggers_LoggerMin_write8));
...
__FAR__ const CT__ti_sysbios_utils_Load_Module__loggerObj ti_sysbios_utils_Load_Module__loggerObj__C = ((CT__ti_sysbios_utils_Load_Module__loggerObj)((void*)(xdc_runtime_ILogger_Handle)&ti_uia_loggers_LoggerMin_Object__table__V[0]));

/* Module__loggerFxn0__C */
#pragma DATA_SECTION(ti_sysbios_utils_Load_Module__loggerFxn0__C, ".const:ti_sysbios_utils_Load_Module__loggerFxn0__C");
__FAR__ const CT__ti_sysbios_utils_Load_Module__loggerFxn0 ti_sysbios_utils_Load_Module__loggerFxn0__C = ((CT__ti_sysbios_utils_Load_Module__loggerFxn0)((xdc_Fxn)ti_uia_loggers_LoggerMin_write0));

/* Module__loggerFxn1__C */
#pragma DATA_SECTION(ti_sysbios_utils_Load_Module__loggerFxn1__C, ".const:ti_sysbios_utils_Load_Module__loggerFxn1__C");
__FAR__ const CT__ti_sysbios_utils_Load_Module__loggerFxn1 ti_sysbios_utils_Load_Module__loggerFxn1__C = ((CT__ti_sysbios_utils_Load_Module__loggerFxn1)((xdc_Fxn)ti_uia_loggers_LoggerMin_write1));

/* Module__loggerFxn2__C */
#pragma DATA_SECTION(ti_sysbios_utils_Load_Module__loggerFxn2__C, ".const:ti_sysbios_utils_Load_Module__loggerFxn2__C");
__FAR__ const CT__ti_sysbios_utils_Load_Module__loggerFxn2 ti_sysbios_utils_Load_Module__loggerFxn2__C = ((CT__ti_sysbios_utils_Load_Module__loggerFxn2)((xdc_Fxn)ti_uia_loggers_LoggerMin_write2));

/* Module__loggerFxn4__C */
#pragma DATA_SECTION(ti_sysbios_utils_Load_Module__loggerFxn4__C, ".const:ti_sysbios_utils_Load_Module__loggerFxn4__C");
__FAR__ const CT__ti_sysbios_utils_Load_Module__loggerFxn4 ti_sysbios_utils_Load_Module__loggerFxn4__C = ((CT__ti_sysbios_utils_Load_Module__loggerFxn4)((xdc_Fxn)ti_uia_loggers_LoggerMin_write4));

/* Module__loggerFxn8__C */
#pragma DATA_SECTION(ti_sysbios_utils_Load_Module__loggerFxn8__C, ".const:ti_sysbios_utils_Load_Module__loggerFxn8__C");
__FAR__ const CT__ti_sysbios_utils_Load_Module__loggerFxn8 ti_sysbios_utils_Load_Module__loggerFxn8__C = ((CT__ti_sysbios_utils_Load_Module__loggerFxn8)((xdc_Fxn)ti_uia_loggers_LoggerMin_write8));
...
__FAR__ const CT__ti_sysbios_utils_Load_LS_cpuLoad ti_sysbios_utils_Load_LS_cpuLoad__C = (((xdc_runtime_Log_Event)7459) << 16 | 2048);

/* LS_hwiLoad__C */
#pragma DATA_SECTION(ti_sysbios_utils_Load_LS_hwiLoad__C, ".const:ti_sysbios_utils_Load_LS_hwiLoad__C");
__FAR__ const CT__ti_sysbios_utils_Load_LS_hwiLoad ti_sysbios_utils_Load_LS_hwiLoad__C = (((xdc_runtime_Log_Event)7476) << 16 | 2048);

/* LS_swiLoad__C */
#pragma DATA_SECTION(ti_sysbios_utils_Load_LS_swiLoad__C, ".const:ti_sysbios_utils_Load_LS_swiLoad__C");
__FAR__ const CT__ti_sysbios_utils_Load_LS_swiLoad ti_sysbios_utils_Load_LS_swiLoad__C = (((xdc_runtime_Log_Event)7494) << 16 | 2048);

/* LS_taskLoad__C */
#pragma DATA_SECTION(ti_sysbios_utils_Load_LS_taskLoad__C, ".const:ti_sysbios_utils_Load_LS_taskLoad__C");
__FAR__ const CT__ti_sysbios_utils_Load_LS_taskLoad ti_sysbios_utils_Load_LS_taskLoad__C = (((xdc_runtime_Log_Event)7512) << 16 | 2048);
...
__FAR__ const CT__ti_uia_events_DvtTypes_Module__id ti_uia_events_DvtTypes_Module__id__C = (xdc_Bits16)0x802b;
...
__FAR__ const CT__ti_uia_events_UIAErr_Module__id ti_uia_events_UIAErr_Module__id__C = (xdc_Bits16)0x802c;
...
__FAR__ const CT__ti_uia_events_UIAEvt_Module__id ti_uia_events_UIAEvt_Module__id__C = (xdc_Bits16)0x802d;
...
/*
 * ======== ti.uia.loggers.LoggerMin INITIALIZERS ========
 */

/* Object__DESC__C */
__FAR__ const xdc_runtime_Core_ObjDesc ti_uia_loggers_LoggerMin_Object__DESC__C;

/* Object__PARAMS__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Object__PARAMS__C, ".const:ti_uia_loggers_LoggerMin_Object__PARAMS__C");
__FAR__ const ti_uia_loggers_LoggerMin_Params ti_uia_loggers_LoggerMin_Object__PARAMS__C = {
    sizeof (ti_uia_loggers_LoggerMin_Params), /* __size */
    0, /* __self */
    0, /* __fxns */
    (xdc_runtime_IInstance_Params*)&ti_uia_loggers_LoggerMin_Object__PARAMS__C.__iprms, /* instance */
    {
        sizeof (xdc_runtime_IInstance_Params), /* __size */
        0,  /* name */
    },  /* instance */
...
/* Module__root__V */
ti_uia_loggers_LoggerMin_Module__ ti_uia_loggers_LoggerMin_Module__root__V = {
    {&ti_uia_loggers_LoggerMin_Module__root__V.link,  /* link.next */
    &ti_uia_loggers_LoggerMin_Module__root__V.link},  /* link.prev */
};

/* Object__table__V */
ti_uia_loggers_LoggerMin_Object__ ti_uia_loggers_LoggerMin_Object__table__V[1] = {
    {/* instance#0 */
        &ti_uia_loggers_LoggerMin_Module__FXNS__C,
    },
};
...
/* Module__state__V */
#if defined (__ICCARM__)
#pragma location = ".data_ti_uia_loggers_LoggerMin_Module__state__V"
#endif
#if defined(__GNUC__) && !(defined(__MACH__) && defined(__APPLE__))
#ifndef __TI_COMPILER_VERSION__
ti_uia_loggers_LoggerMin_Module_State__ ti_uia_loggers_LoggerMin_Module__state__V __attribute__ ((section(".data_ti_uia_loggers_LoggerMin_Module__state__V")));
#endif
#endif
ti_uia_loggers_LoggerMin_Module_State__ ti_uia_loggers_LoggerMin_Module__state__V = {
    1,  /* enabled */
    ...
    (xdc_UInt16)0x0,  /* droppedEvents */
    ((void*)ti_uia_loggers_LoggerMin_Module_State_0_packetBuffer__A),  /* packetBuffer */
    ((xdc_UInt32*)((void*)&ti_uia_loggers_LoggerMin_Module_State_0_packetBuffer__A[0])),  /* start */
    ((xdc_UInt32*)((void*)&ti_uia_loggers_LoggerMin_Module_State_0_packetBuffer__A[4])),  /* write */
    ((xdc_UInt32*)((void*)&ti_uia_loggers_LoggerMin_Module_State_0_packetBuffer__A[508])),  /* end */
    (xdc_UInt16)0x0,  /* eventSequenceNum */
    (xdc_UInt16)0x0,  /* pktSequenceNum */
    ti_uia_runtime_EventHdr_HdrType_EventWithPrevLenWith32bTimestamp,  /* eventType */
};

/* Module__diagsEnabled__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__diagsEnabled__C, ".const:ti_uia_loggers_LoggerMin_Module__diagsEnabled__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__diagsEnabled ti_uia_loggers_LoggerMin_Module__diagsEnabled__C = (xdc_Bits32)0x90;

/* Module__diagsIncluded__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__diagsIncluded__C, ".const:ti_uia_loggers_LoggerMin_Module__diagsIncluded__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__diagsIncluded ti_uia_loggers_LoggerMin_Module__diagsIncluded__C = (xdc_Bits32)0x90;

/* Module__diagsMask__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__diagsMask__C, ".const:ti_uia_loggers_LoggerMin_Module__diagsMask__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__diagsMask ti_uia_loggers_LoggerMin_Module__diagsMask__C = ((CT__ti_uia_loggers_LoggerMin_Module__diagsMask)0);

/* Module__gateObj__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__gateObj__C, ".const:ti_uia_loggers_LoggerMin_Module__gateObj__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__gateObj ti_uia_loggers_LoggerMin_Module__gateObj__C = ((CT__ti_uia_loggers_LoggerMin_Module__gateObj)0);

/* Module__gatePrms__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__gatePrms__C, ".const:ti_uia_loggers_LoggerMin_Module__gatePrms__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__gatePrms ti_uia_loggers_LoggerMin_Module__gatePrms__C = ((CT__ti_uia_loggers_LoggerMin_Module__gatePrms)0);

/* Module__id__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__id__C, ".const:ti_uia_loggers_LoggerMin_Module__id__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__id ti_uia_loggers_LoggerMin_Module__id__C = (xdc_Bits16)0x803b;

/* Module__loggerDefined__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__loggerDefined__C, ".const:ti_uia_loggers_LoggerMin_Module__loggerDefined__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__loggerDefined ti_uia_loggers_LoggerMin_Module__loggerDefined__C = 0;

/* Module__loggerObj__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__loggerObj__C, ".const:ti_uia_loggers_LoggerMin_Module__loggerObj__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__loggerObj ti_uia_loggers_LoggerMin_Module__loggerObj__C = ((CT__ti_uia_loggers_LoggerMin_Module__loggerObj)0);

/* Module__loggerFxn0__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__loggerFxn0__C, ".const:ti_uia_loggers_LoggerMin_Module__loggerFxn0__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__loggerFxn0 ti_uia_loggers_LoggerMin_Module__loggerFxn0__C = ((CT__ti_uia_loggers_LoggerMin_Module__loggerFxn0)0);

/* Module__loggerFxn1__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__loggerFxn1__C, ".const:ti_uia_loggers_LoggerMin_Module__loggerFxn1__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__loggerFxn1 ti_uia_loggers_LoggerMin_Module__loggerFxn1__C = ((CT__ti_uia_loggers_LoggerMin_Module__loggerFxn1)0);

/* Module__loggerFxn2__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__loggerFxn2__C, ".const:ti_uia_loggers_LoggerMin_Module__loggerFxn2__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__loggerFxn2 ti_uia_loggers_LoggerMin_Module__loggerFxn2__C = ((CT__ti_uia_loggers_LoggerMin_Module__loggerFxn2)0);

/* Module__loggerFxn4__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__loggerFxn4__C, ".const:ti_uia_loggers_LoggerMin_Module__loggerFxn4__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__loggerFxn4 ti_uia_loggers_LoggerMin_Module__loggerFxn4__C = ((CT__ti_uia_loggers_LoggerMin_Module__loggerFxn4)0);

/* Module__loggerFxn8__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__loggerFxn8__C, ".const:ti_uia_loggers_LoggerMin_Module__loggerFxn8__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__loggerFxn8 ti_uia_loggers_LoggerMin_Module__loggerFxn8__C = ((CT__ti_uia_loggers_LoggerMin_Module__loggerFxn8)0);

/* Module__startupDoneFxn__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Module__startupDoneFxn__C, ".const:ti_uia_loggers_LoggerMin_Module__startupDoneFxn__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Module__startupDoneFxn ti_uia_loggers_LoggerMin_Module__startupDoneFxn__C = ((CT__ti_uia_loggers_LoggerMin_Module__startupDoneFxn)0);

/* Object__count__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Object__count__C, ".const:ti_uia_loggers_LoggerMin_Object__count__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Object__count ti_uia_loggers_LoggerMin_Object__count__C = 1;

/* Object__heap__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Object__heap__C, ".const:ti_uia_loggers_LoggerMin_Object__heap__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Object__heap ti_uia_loggers_LoggerMin_Object__heap__C = 0;

/* Object__sizeof__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Object__sizeof__C, ".const:ti_uia_loggers_LoggerMin_Object__sizeof__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Object__sizeof ti_uia_loggers_LoggerMin_Object__sizeof__C = sizeof(ti_uia_loggers_LoggerMin_Object__);

/* Object__table__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Object__table__C, ".const:ti_uia_loggers_LoggerMin_Object__table__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_Object__table ti_uia_loggers_LoggerMin_Object__table__C = ti_uia_loggers_LoggerMin_Object__table__V;

/* bufSize__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_bufSize__C, ".const:ti_uia_loggers_LoggerMin_bufSize__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_bufSize ti_uia_loggers_LoggerMin_bufSize__C = (xdc_SizeT)0x200;

/* numCores__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_numCores__C, ".const:ti_uia_loggers_LoggerMin_numCores__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_numCores ti_uia_loggers_LoggerMin_numCores__C = (xdc_Int)0x1;

/* timestampSize__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_timestampSize__C, ".const:ti_uia_loggers_LoggerMin_timestampSize__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_timestampSize ti_uia_loggers_LoggerMin_timestampSize__C = ti_uia_loggers_LoggerMin_TimestampSize_32b;

/* L_test__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_L_test__C, ".const:ti_uia_loggers_LoggerMin_L_test__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_L_test ti_uia_loggers_LoggerMin_L_test__C = (((xdc_runtime_Log_Event)7444) << 16 | 256);

/* supportLoggerDisable__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_supportLoggerDisable__C, ".const:ti_uia_loggers_LoggerMin_supportLoggerDisable__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_supportLoggerDisable ti_uia_loggers_LoggerMin_supportLoggerDisable__C = 0;

/* endpointId__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_endpointId__C, ".const:ti_uia_loggers_LoggerMin_endpointId__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_endpointId ti_uia_loggers_LoggerMin_endpointId__C = (xdc_Bits16)0x0;

/* loggerInstanceId__C */
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_loggerInstanceId__C, ".const:ti_uia_loggers_LoggerMin_loggerInstanceId__C");
__FAR__ const CT__ti_uia_loggers_LoggerMin_loggerInstanceId ti_uia_loggers_LoggerMin_loggerInstanceId__C = (xdc_Bits16)0x0;
...
__FAR__ const CT__ti_uia_runtime_EventHdr_Module__id ti_uia_runtime_EventHdr_Module__id__C = (xdc_Bits16)0x802f;
...
__FAR__ const CT__xdc_runtime_HeapStd_E_noRTSMemory xdc_runtime_HeapStd_E_noRTSMemory__C = (((xdc_runtime_Error_Id)4113) << 16 | 0);
...
__FAR__ const CT__xdc_runtime_Main_Module__loggerObj xdc_runtime_Main_Module__loggerObj__C = ((CT__xdc_runtime_Main_Module__loggerObj)((void*)(xdc_runtime_ILogger_Handle)&ti_uia_loggers_LoggerMin_Object__table__V[0]));

/* Module__loggerFxn0__C */
#pragma DATA_SECTION(xdc_runtime_Main_Module__loggerFxn0__C, ".const:xdc_runtime_Main_Module__loggerFxn0__C");
__FAR__ const CT__xdc_runtime_Main_Module__loggerFxn0 xdc_runtime_Main_Module__loggerFxn0__C = ((CT__xdc_runtime_Main_Module__loggerFxn0)((xdc_Fxn)ti_uia_loggers_LoggerMin_write0));

/* Module__loggerFxn1__C */
#pragma DATA_SECTION(xdc_runtime_Main_Module__loggerFxn1__C, ".const:xdc_runtime_Main_Module__loggerFxn1__C");
__FAR__ const CT__xdc_runtime_Main_Module__loggerFxn1 xdc_runtime_Main_Module__loggerFxn1__C = ((CT__xdc_runtime_Main_Module__loggerFxn1)((xdc_Fxn)ti_uia_loggers_LoggerMin_write1));

/* Module__loggerFxn2__C */
#pragma DATA_SECTION(xdc_runtime_Main_Module__loggerFxn2__C, ".const:xdc_runtime_Main_Module__loggerFxn2__C");
__FAR__ const CT__xdc_runtime_Main_Module__loggerFxn2 xdc_runtime_Main_Module__loggerFxn2__C = ((CT__xdc_runtime_Main_Module__loggerFxn2)((xdc_Fxn)ti_uia_loggers_LoggerMin_write2));

/* Module__loggerFxn4__C */
#pragma DATA_SECTION(xdc_runtime_Main_Module__loggerFxn4__C, ".const:xdc_runtime_Main_Module__loggerFxn4__C");
__FAR__ const CT__xdc_runtime_Main_Module__loggerFxn4 xdc_runtime_Main_Module__loggerFxn4__C = ((CT__xdc_runtime_Main_Module__loggerFxn4)((xdc_Fxn)ti_uia_loggers_LoggerMin_write4));

/* Module__loggerFxn8__C */
#pragma DATA_SECTION(xdc_runtime_Main_Module__loggerFxn8__C, ".const:xdc_runtime_Main_Module__loggerFxn8__C");
__FAR__ const CT__xdc_runtime_Main_Module__loggerFxn8 xdc_runtime_Main_Module__loggerFxn8__C = ((CT__xdc_runtime_Main_Module__loggerFxn8)((xdc_Fxn)ti_uia_loggers_LoggerMin_write8));
...
__FAR__ const CT__xdc_runtime_Registry_Module__loggerObj xdc_runtime_Registry_Module__loggerObj__C = ((CT__xdc_runtime_Registry_Module__loggerObj)((void*)(xdc_runtime_ILogger_Handle)&ti_uia_loggers_LoggerMin_Object__table__V[0]));

/* Module__loggerFxn0__C */
#pragma DATA_SECTION(xdc_runtime_Registry_Module__loggerFxn0__C, ".const:xdc_runtime_Registry_Module__loggerFxn0__C");
__FAR__ const CT__xdc_runtime_Registry_Module__loggerFxn0 xdc_runtime_Registry_Module__loggerFxn0__C = ((CT__xdc_runtime_Registry_Module__loggerFxn0)((xdc_Fxn)ti_uia_loggers_LoggerMin_write0));

/* Module__loggerFxn1__C */
#pragma DATA_SECTION(xdc_runtime_Registry_Module__loggerFxn1__C, ".const:xdc_runtime_Registry_Module__loggerFxn1__C");
__FAR__ const CT__xdc_runtime_Registry_Module__loggerFxn1 xdc_runtime_Registry_Module__loggerFxn1__C = ((CT__xdc_runtime_Registry_Module__loggerFxn1)((xdc_Fxn)ti_uia_loggers_LoggerMin_write1));

/* Module__loggerFxn2__C */
#pragma DATA_SECTION(xdc_runtime_Registry_Module__loggerFxn2__C, ".const:xdc_runtime_Registry_Module__loggerFxn2__C");
__FAR__ const CT__xdc_runtime_Registry_Module__loggerFxn2 xdc_runtime_Registry_Module__loggerFxn2__C = ((CT__xdc_runtime_Registry_Module__loggerFxn2)((xdc_Fxn)ti_uia_loggers_LoggerMin_write2));

/* Module__loggerFxn4__C */
#pragma DATA_SECTION(xdc_runtime_Registry_Module__loggerFxn4__C, ".const:xdc_runtime_Registry_Module__loggerFxn4__C");
__FAR__ const CT__xdc_runtime_Registry_Module__loggerFxn4 xdc_runtime_Registry_Module__loggerFxn4__C = ((CT__xdc_runtime_Registry_Module__loggerFxn4)((xdc_Fxn)ti_uia_loggers_LoggerMin_write4));

/* Module__loggerFxn8__C */
#pragma DATA_SECTION(xdc_runtime_Registry_Module__loggerFxn8__C, ".const:xdc_runtime_Registry_Module__loggerFxn8__C");
__FAR__ const CT__xdc_runtime_Registry_Module__loggerFxn8 xdc_runtime_Registry_Module__loggerFxn8__C = ((CT__xdc_runtime_Registry_Module__loggerFxn8)((xdc_Fxn)ti_uia_loggers_LoggerMin_write8));
...
const __T1_xdc_runtime_Startup_sfxnTab xdc_runtime_Startup_sfxnTab__A[10] = {
    ...
    ((xdc_Int(*)(xdc_Int))((xdc_Fxn)ti_uia_loggers_LoggerMin_Module_startup__E)),  /* [7] */
...
const __T1_xdc_runtime_Text_nodeTab xdc_runtime_Text_nodeTab__A[65] = {
    ...
    },  /* [49] */
    {
        ...
        (xdc_Bits16)0x1ece,  /* right */
    },  /* [50] */
    {
        (xdc_Bits16)0x8031,  /* left */
        (xdc_Bits16)0x1ed6,  /* right */
    },  /* [51] */
    {
        (xdc_Bits16)0x801a,  /* left */
    ...
    {
        (xdc_Bits16)0x8036,  /* left */
        (xdc_Bits16)0x1efe,  /* right */
    },  /* [57] */
    {
        (xdc_Bits16)0x8029,  /* left */
        (xdc_Bits16)0x1f0a,  /* right */
    },  /* [58] */
    {
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1f77;
...
/*
 * ======== ti.uia.loggers.LoggerMin OBJECT DESCRIPTOR ========
 */

/* Object__DESC__C */
typedef struct { ti_uia_loggers_LoggerMin_Object2__ s0; char c; } ti_uia_loggers_LoggerMin___S1;
#pragma DATA_SECTION(ti_uia_loggers_LoggerMin_Object__DESC__C, ".const:ti_uia_loggers_LoggerMin_Object__DESC__C");
__FAR__ const xdc_runtime_Core_ObjDesc ti_uia_loggers_LoggerMin_Object__DESC__C = {
    (xdc_Ptr)&ti_uia_loggers_LoggerMin_Module__FXNS__C, /* fxnTab */
    &ti_uia_loggers_LoggerMin_Module__root__V.link, /* modLink */
    sizeof(ti_uia_loggers_LoggerMin___S1) - sizeof(ti_uia_loggers_LoggerMin_Object2__), /* objAlign */
    0, /* objHeap */
    0, /* objName */
    sizeof(ti_uia_loggers_LoggerMin_Object2__), /* objSize */
    (xdc_Ptr)&ti_uia_loggers_LoggerMin_Object__PARAMS__C, /* prmsInit */
    sizeof(ti_uia_loggers_LoggerMin_Params), /* prmsSize */
};
...
/*
 * ======== ti.uia.loggers.LoggerMin SYSTEM FUNCTIONS ========
 */
...
/* Module__startupDone__S */
xdc_Bool ti_uia_loggers_LoggerMin_Module__startupDone__S( void )
{
    return ti_uia_loggers_LoggerMin_Module__startupDone__F();
}

/* Handle__label__S */
xdc_runtime_Types_Label *ti_uia_loggers_LoggerMin_Handle__label__S(xdc_Ptr obj, xdc_runtime_Types_Label *lab) 
{
    lab->handle = obj;
    lab->modId = 32827;
    xdc_runtime_Core_assignLabel(lab, 0, 0);
...
/* Params__init__S */
xdc_Void ti_uia_loggers_LoggerMin_Params__init__S( xdc_Ptr prms, const void *src, xdc_SizeT psz, xdc_SizeT isz ) 
{
    xdc_runtime_Core_assignParams__I(prms, (xdc_Ptr)(src ? src : &ti_uia_loggers_LoggerMin_Object__PARAMS__C), psz, isz);
}

/* Object__get__S */
xdc_Ptr ti_uia_loggers_LoggerMin_Object__get__S(xdc_Ptr oa, xdc_Int i)
{
    if (oa) {
        return ((ti_uia_loggers_LoggerMin_Object__ *)oa) + i;
    }

    if (ti_uia_loggers_LoggerMin_Object__count__C == 0) {
        return NULL;
    }

    return ((ti_uia_loggers_LoggerMin_Object__ *)ti_uia_loggers_LoggerMin_Object__table__C) + i;
}

/* Object__first__S */
xdc_Ptr ti_uia_loggers_LoggerMin_Object__first__S( void ) 
{
    xdc_runtime_Types_InstHdr *iHdr = (xdc_runtime_Types_InstHdr *)ti_uia_loggers_LoggerMin_Module__root__V.link.next;

    if (iHdr != (xdc_runtime_Types_InstHdr *)&ti_uia_loggers_LoggerMin_Module__root__V.link) {
        return iHdr + 1;
    }
    else {
        return NULL;
...
/* Object__next__S */
xdc_Ptr ti_uia_loggers_LoggerMin_Object__next__S( xdc_Ptr obj ) 
{
    xdc_runtime_Types_InstHdr *iHdr = ((xdc_runtime_Types_InstHdr *)obj) - 1;

    if (iHdr->link.next != (xdc_runtime_Types_Link *)&ti_uia_loggers_LoggerMin_Module__root__V.link) {
        return (xdc_runtime_Types_InstHdr *)(iHdr->link.next) + 1;
    }
    else {
        return NULL;
...
/* Object__create__S */
xdc_Ptr ti_uia_loggers_LoggerMin_Object__create__S (
    xdc_Ptr __obj, 
    xdc_SizeT __osz,
    const xdc_Ptr __aa,
    const ti_uia_loggers_LoggerMin___ParamsPtr __paramsPtr,
    xdc_SizeT __psz,
    xdc_runtime_Error_Block *__eb)
{
    ti_uia_loggers_LoggerMin_Params __prms;
    ti_uia_loggers_LoggerMin_Object *__newobj;

    /* common instance initialization */
    __newobj = xdc_runtime_Core_createObject__I(&ti_uia_loggers_LoggerMin_Object__DESC__C, __obj, &__prms, (xdc_Ptr)__paramsPtr, sizeof(ti_uia_loggers_LoggerMin_Params), __eb);
    if (__newobj == NULL) {
        return NULL;
    }

    /* module-specific initialization */
    ti_uia_loggers_LoggerMin_Instance_init__E(__newobj, &__prms);
    return __newobj;
}

/* create */
ti_uia_loggers_LoggerMin_Handle ti_uia_loggers_LoggerMin_create( const ti_uia_loggers_LoggerMin_Params *__paramsPtr, xdc_runtime_Error_Block *__eb )
{
    ti_uia_loggers_LoggerMin_Params __prms;
    ti_uia_loggers_LoggerMin_Object *__newobj;

    /* common instance initialization */
    __newobj = xdc_runtime_Core_createObject__I(&ti_uia_loggers_LoggerMin_Object__DESC__C, 0, &__prms, (xdc_Ptr)__paramsPtr, sizeof(ti_uia_loggers_LoggerMin_Params), __eb);
    if (__newobj == NULL) {
        return NULL;
    }
...
/* construct */
void ti_uia_loggers_LoggerMin_construct(ti_uia_loggers_LoggerMin_Struct *__obj, const ti_uia_loggers_LoggerMin_Params *__paramsPtr )
{
    ti_uia_loggers_LoggerMin_Params __prms;

    /* common instance initialization */
    xdc_runtime_Core_constructObject__I(&ti_uia_loggers_LoggerMin_Object__DESC__C, __obj, &__prms, (xdc_Ptr)__paramsPtr, sizeof(ti_uia_loggers_LoggerMin_Params), NULL);
    /* module-specific initialization */
    ti_uia_loggers_LoggerMin_Instance_init__E((xdc_Ptr)__obj, &__prms);
}

/* Object__destruct__S */
xdc_Void ti_uia_loggers_LoggerMin_Object__destruct__S( xdc_Ptr obj ) 
{
    xdc_runtime_Core_deleteObject__I(&ti_uia_loggers_LoggerMin_Object__DESC__C, obj, NULL, -1, TRUE);
}

/* destruct */
void ti_uia_loggers_LoggerMin_destruct(ti_uia_loggers_LoggerMin_Struct *obj)
{
    ti_uia_loggers_LoggerMin_Object__destruct__S(obj);
}

/* Object__delete__S */
xdc_Void ti_uia_loggers_LoggerMin_Object__delete__S( xdc_Ptr instp ) 
{
    xdc_runtime_Core_deleteObject__I(&ti_uia_loggers_LoggerMin_Object__DESC__C, *((ti_uia_loggers_LoggerMin_Object**)instp), NULL, -1, FALSE);
    *((ti_uia_loggers_LoggerMin_Handle*)instp) = NULL;
}

/* delete */
void ti_uia_loggers_LoggerMin_delete(ti_uia_loggers_LoggerMin_Handle *instp)
{
    ti_uia_loggers_LoggerMin_Object__delete__S(instp);
}
...
#endif
#endif
const ti_sysbios_knl_Swi_Handle LEDSwi = (ti_sysbios_knl_Swi_Handle)((ti_sysbios_knl_Swi_Handle)&ti_sysbios_knl_Swi_Object__table__V[0]);
